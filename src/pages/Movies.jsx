...
// Libros de la tienda
import booksEN from "../data/en/movies.json";
import booksES from "../data/es/movies.json";
...
const Movies = () => {
    ...
    return (
        <div className="w-full flex flex-col items-center justify-center">
            <h1 className="text-4xl text-[#004D43] font-bold mt-10">{t('movies_head')}</h1>
            ...
            <div className="max-w-[1300px] w-full px-4">
                ...
                <div className="flex flex-col items-center justify-center mt-6">
                    <h4 className="text-4xl text-center text-[#004D43] font-bold mt-10">{t('movies_next')}</h4>
